...
const CarProfile = ({ caridl, carnamel, carphonel, caremaill, cartypel, callback }) => {

    console.log(caridl);
    console.log(carnamel);
    console.log(carphonel);
    console.log(caremaill);
    console.log(cartypel);


    const [name, setName] = useState(carnamel);
    const [phone, setPhone] = useState(carphonel);
    const [email, setEmail] = useState(caremaill);
    const [type, setType] = useState(cartypel);
